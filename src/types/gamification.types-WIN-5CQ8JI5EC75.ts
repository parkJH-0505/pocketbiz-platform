...
export interface RewardCondition {
  type: 'first_time' | 'time_based' | 'streak' | 'threshold' | 'level' |
        'absence' | 'combination' | 'random' | 'social' | 'daily';
  action?: string;
...
export interface SpecialReward {
  ...
  type: 'virtual' | 'real' | 'discount' | 'feature' | 'recognition' |
        'instant' | 'achievement' | 'hidden' | 'milestone' | 'social' |
        'random' | 'daily';
  ...
  rewards?: {
    ...
    badge?: string;
    title?: string;
    boost?: { type: string; multiplier: number; duration: number };
    lootBox?: string;
    feature?: string;
  };
