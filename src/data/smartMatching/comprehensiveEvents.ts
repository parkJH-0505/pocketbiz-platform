...
// 종합 이벤트 데이터 (20개) - 2024년 9월 10일 이후 날짜로 업데이트
export const comprehensiveEvents: MatchingResult[] = [
  ...
  // 2. 정부지원사업
  {
    event: {
      ...
      applicationStartDate: new Date('2025-09-10'),
      applicationEndDate: new Date('2025-09-20'),
  ...
  // 3. VC 투자 프로그램
  {
    event: {
      ...
      applicationStartDate: new Date('2025-09-01'),
      applicationEndDate: new Date('2025-09-22'),
  ...
  // 4. 액셀러레이터
  {
    event: {
      ...
      applicationStartDate: new Date('2025-09-01'),
      applicationEndDate: new Date('2025-09-23'),
  ...
  // 5. 오픈이노베이션
  {
    event: {
      ...
      applicationEndDate: new Date('2025-09-18'),
  ...
  // 6. 융자 프로그램
  {
    event: {
      ...
      applicationEndDate: new Date('2025-09-19'),
  ...
  // 7. 해외진출 지원
  {
    event: {
      ...
      announcementDate: new Date('2025-09-28'),
      applicationStartDate: new Date('2025-10-15'),
      applicationEndDate: new Date('2025-09-17'),
  ...
  // 8. 시설/공간 지원
  {
    event: {
      ...
      applicationEndDate: new Date('2025-09-16'),
  ...
  // 9. 교육/멘토링 프로그램
  {
    event: {
      ...
      applicationStartDate: new Date('2025-10-20'),
  ...
  // 10. 입찰 기회
  {
    event: {
      ...
      announcementDate: new Date('2025-10-01'),
      applicationStartDate: new Date('2025-09-14'),
      applicationEndDate: new Date('2025-09-24'),
      keywords: ['공공입찰', 'AI', 'SI'],
  ...
  // 11. 중기부 창업지원
  {
    event: {
      ...
      announcementDate: new Date('2025-09-05'),
      applicationStartDate: new Date('2025-09-15'),
      applicationEndDate: new Date('2025-09-25'),
  ...
  // 12. 소셜벤처 지원
  {
    event: {
      ...
      announcementDate: new Date('2025-09-08'),
      applicationStartDate: new Date('2025-09-20'),
      applicationEndDate: new Date('2025-09-26'),
  ...
  // 13. 기술보증기금
  {
    event: {
      ...
      applicationStartDate: new Date('2025-09-17'),
      applicationEndDate: new Date('2025-09-27'),
  ...
  // 14. AWS 클라우드 지원
  {
    event: {
      ...
      demoDay: false,
      announcementDate: new Date('2025-09-01'),
      applicationStartDate: new Date('2025-09-01'),
      applicationEndDate: new Date('2025-09-28'),
  ...
  // 15. 바이오 특화 지원
  {
    event: {
      ...
      announcementDate: new Date('2025-10-03'),
      applicationStartDate: new Date('2025-10-20'),
      applicationEndDate: new Date('2025-09-25'),
  ...
  // 16. 콘텐츠 산업 지원
  {
    event: {
      ...
      announcementDate: new Date('2025-09-24'),
      applicationStartDate: new Date('2025-10-12'),
      applicationEndDate: new Date('2025-09-30'),
  ...
  // 17. 여성창업 지원
  {
    event: {
      ...
      announcementDate: new Date('2025-09-26'),
      applicationStartDate: new Date('2025-09-08'),
      applicationEndDate: new Date('2025-09-29'),
  ...
  // 18. 핀테크 특화
  {
    event: {
      ...
      demoDay: true,
      announcementDate: new Date('2025-09-29'),
      applicationStartDate: new Date('2025-10-15'),
      applicationEndDate: new Date('2025-09-26'),
  ...
  // 19. 그린/ESG 지원
  {
    event: {
      ...
      announcementDate: new Date('2025-10-02'),
      applicationStartDate: new Date('2025-10-18'),
      applicationEndDate: new Date('2025-09-27'),
  ...
  // 20. 대학 연계 창업
  {
    event: {
      ...
      announcementDate: new Date('2025-09-31'),
      applicationStartDate: new Date('2025-10-14'),
      applicationEndDate: new Date('2025-09-28'),
