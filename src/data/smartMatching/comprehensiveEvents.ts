...
export const comprehensiveEvents: MatchingResult[] = [
  ...
  // 10. 입찰 기회
  {
    event: {
      ...
      applicationStartDate: new Date('2025-10-10'),
  ...
  // 15. 바이오 특화 지원
  {
    event: {
      ...
      applicationStartDate: new Date('2025-10-20'),
      applicationEndDate: new Date('2025-03-25'),
  ...
  // 16. 콘텐츠 산업 지원
  {
    event: {
      ...
      applicationEndDate: new Date('2025-03-08'),
  ...
  // 17. 여성창업 지원
  {
    event: {
      ...
      applicationStartDate: new Date('2025-10-08'),
      applicationEndDate: new Date('2025-10-26'),
  ...
  // 18. 핀테크 특화
  {
    event: {
      ...
      applicationStartDate: new Date('2025-10-15'),
      applicationEndDate: new Date('2025-03-12'),
  ...
  // 19. 그린/ESG 지원
  {
    event: {
      ...
      applicationEndDate: new Date('2025-03-18'),
  ...
  // 20. 대학 연계 창업
  {
    event: {
      ...
      applicationEndDate: new Date('2025-03-14'),
